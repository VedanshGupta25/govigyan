...
import { FileSpreadsheet, Calendar, Grid } from 'lucide-react';
...
const SpreadsheetCard: React.FC<SpreadsheetCardProps> = ({ spreadsheet }) => {
    ...
    >
      <div className="doc-card-preview bg-gradient-to-br from-secondary/10 to-primary/10">
        <div className="h-full w-full flex flex-col items-center justify-center p-4">
          <FileSpreadsheet className="h-16 w-16 text-secondary mb-2" />
